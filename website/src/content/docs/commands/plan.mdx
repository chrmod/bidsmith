...
4. Resources in the live account with no `.bid` match are **not**
   shown today — they're "stuff bidsmith doesn't manage." Label-based
   matching (and `- destroy` rows) is on the roadmap.
